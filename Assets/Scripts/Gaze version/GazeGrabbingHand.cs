...
public class GazeGrabbingHand : MonoBehaviour
{
                ...
                if (Vector3.Distance(hand.transform.position, hookTarget) < 0.01f)
                {
                    ...
                    if (touched != null)
                    {
                        if (touched.CompareTag("Ghost"))
                        {
                            ...
                            GhostBehavior ghostScript = touched.GetComponent<GhostBehavior>();
                            if (ghostScript.currentState == GhostBehavior.GhostState.Stunned)
                            {
                                grabbed = touched;
